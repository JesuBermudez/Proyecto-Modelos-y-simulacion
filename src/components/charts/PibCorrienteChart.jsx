...
export default function PibCorrienteChart() {
  ...
  useEffect(() => {
    axios
      .get(
        "https://api-node-motor-finaciero-production.up.railway.app/api/macro/pibcorriente/colombia"
      )
      .then((response) => {
        let apiData = response.data.pibCurrentData;
